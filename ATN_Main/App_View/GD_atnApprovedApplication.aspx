<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="GD_atnApprovedApplication.aspx.vb" Inherits="GD_atnApprovedApplication" title="Display List: Approved Application" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cph1" Runat="Server">
    ...
    <div id="div3" class="caption">
			<asp:Label ID="LabelatnAppliedApplications" runat="server"  Text="&nbsp;List Approved Applications"></asp:Label>
    </div>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
  <ContentTemplate>
    <LGM:ToolBar0 
      ...
      ToolType = "lgNDGrid"
      EnableAdd = "False"
      ValidationGroup = "atnApprovedApplication"
      SearchContext = "atnApprovedApplication"
      runat = "server" />
    ...
    <asp:GridView runat="server"  SkinId="gv_silver" ID="GridView1" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataSourceID="ObjectDataSource1" DataKeyNames="LeaveApplID">
      <Columns>
        ...
        <asp:TemplateField HeaderText="Approval Remark" SortExpression="ApprovalRemark">
          <ItemTemplate>
            <asp:Label ID="LabelApprovalRemark" runat="server" Text='<%# Bind("ApprovalRemark") %>'></asp:Label>
          </ItemTemplate>
        <HeaderStyle Width="100px" />
        </asp:TemplateField>
        <asp:TemplateField HeaderText="Approval On" SortExpression="ApprovalOn">
          <ItemTemplate>
            <asp:Label ID="LabelApprovalOn" runat="server" Text='<%# Bind("ApprovalOn") %>'></asp:Label>
          </ItemTemplate>
    ...
    <asp:ObjectDataSource 
      ...
      runat = "server"
      DataObjectTypeName = "SIS.ATN.atnApprovedApplication"
      OldValuesParameterFormatString = "original_{0}"
      SelectMethod = "SelectList"
      TypeName = "SIS.ATN.atnApprovedApplication"
