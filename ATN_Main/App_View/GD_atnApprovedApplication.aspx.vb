Partial Class GD_atnApprovedApplication
  ...
  Protected Sub GridView1_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles GridView1.Init
    DataClassName = "GatnApprovedApplication"
    SetGridView = GridView1
  End Sub
  Private _InfoUrl As String = "~/ATN_Main/App_Display/DF_atnApprovedApplication.aspx"
