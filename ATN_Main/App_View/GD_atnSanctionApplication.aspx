...
<asp:Content ID="Content1" ContentPlaceHolderID="cph1" runat="Server">
  ...
  <div id="div2" class="page">
    <div id="div3" class="caption">
      <asp:Label ID="LabelatnAppliedApplications" runat="server" Text="&nbsp;List Special Sanction Application"></asp:Label>
    </div>
          ...
          <asp:GridView runat="server" SkinID="gv_silver" ID="GridView1" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataSourceID="ObjectDataSource1" DataKeyNames="LeaveApplID">
            <Columns>
              ...
              <asp:TemplateField HeaderText="Comments">
                <ItemTemplate>
                  <asp:TextBox ID="F_Remarks" runat="server" CssClass="mytxt" Width="300px" MaxLength="100" ToolTip="Enter Comments" BehaviorID='<%# Eval("LeaveApplID") %>' Text='<%# Bind("SanctionRemark") %>'></asp:TextBox>
                </ItemTemplate>
                <ItemStyle CssClass="alignleft" />
              ...
              <asp:TemplateField HeaderText="Sanction">
                <ItemTemplate>
                  <asp:ImageButton ID="Sanctioned" runat="server" ToolTip="Click to Sanction" SkinID="forward" BehaviorID='<%# Eval("LeaveApplID") %>' CommandName="Sanctioned" CommandArgument='<%# Eval("LeaveApplID") %>' />
                </ItemTemplate>
                <ItemStyle CssClass="alignCenter" />
                <HeaderStyle CssClass="alignCenter" Width="80px" />
              </asp:TemplateField>
              <asp:TemplateField HeaderText="Return">
                <ItemTemplate>
                  <asp:ImageButton ID="Rejected" runat="server" ToolTip="Click to Reject" SkinID="return" BehaviorID='<%# Eval("LeaveApplID") %>' CommandName="Rejected" CommandArgument='<%# Eval("LeaveApplID") %>' />
                </ItemTemplate>
                <ItemStyle CssClass="alignCenter" />
                <HeaderStyle CssClass="alignCenter" Width="80px" />
              </asp:TemplateField>
