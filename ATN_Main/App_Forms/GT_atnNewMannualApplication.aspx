<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="GT_atnNewMannualApplication.aspx.vb" Inherits="GT_NewMannualApplication" Title="ISGEC:Leave Application[Advance]" %>
...
<div id="div1" class="page">
    <div id="div2" class="caption">
					<asp:Label ID="LabelatnAppliedApplications" runat="server" Font-Bold="True" Font-Size="14px"  Text="Advance Application By HR"></asp:Label>
    </div>
  ...
  <ContentTemplate>
		...
		<table width="100%">
			<tr>
				...
				<td align="center" class="cancel_button">
