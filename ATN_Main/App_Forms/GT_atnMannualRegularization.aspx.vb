Partial Class GT_MannualRegularization
  ...
  End Sub
	...
	Private Function LoadIncompleteAttendance(ByVal CardNo As String) As String
		...
		Dim oInAtns As List(Of SIS.ATN.atnProcessedPunch) = SIS.ATN.atnProcessedPunch.GetAllIncompleteAttendanceWithoutFilter(CardNo)
		...
		For Each oAt As SIS.ATN.atnProcessedPunch In oInAtns
			...
			For Each oLT As SIS.ATN.atnLeaveTypes In oLTs
				If oLT.LeaveTypeID = "FP" Or oLT.LeaveTypeID = "SH" Then Continue For
