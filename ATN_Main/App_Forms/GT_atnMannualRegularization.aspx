<%@ Page Title="ISGEC:Mannual Regularization" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="GT_atnMannualRegularization.aspx.vb" Inherits="GT_MannualRegularization" %>
...
<div id="div1" class="page">
    <div id="div2" class="caption">
					<asp:Label ID="LabelatnAppliedApplications" runat="server" Font-Bold="true" Font-Size="14px" Text="Mannual Regularization by HR"></asp:Label>
    </div>
