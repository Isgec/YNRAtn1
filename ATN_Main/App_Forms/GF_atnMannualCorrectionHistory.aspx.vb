Partial Class GF_atnMannualCorrectionHistory
  ...
  End Sub
  Private _EditUrl As String = "~/ATN_Main/App_Edit/EF_atnMannualCorrectionHistory.aspx"
  Private _AddUrl As String = "~/ATN_Main/App_Create/AF_atnMannualCorrectionHistory.aspx"
  Private _InfoUrl As String = "~/ATN_Main/App_Display/DF_atnMannualCorrectionHistory.aspx"
