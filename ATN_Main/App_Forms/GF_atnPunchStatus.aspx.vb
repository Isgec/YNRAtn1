Partial Class GF_atnPunchStatus
  ...
  Protected Sub GridView1_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles GridView1.Init
    DataClassName = "GatnPunchStatus"
    SetGridView = GridView1
  End Sub
  Private _EditUrl As String = "~/ATN_Main/App_Edit/EF_atnPunchStatus.aspx"
  Private _AddUrl As String = "~/ATN_Main/App_Create/AF_atnPunchStatus.aspx"
  Private _InfoUrl As String = "~/ATN_Main/App_Display/DF_atnPunchStatus.aspx"
