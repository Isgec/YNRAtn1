<%@ Page Title="ISGEC:Regularize TS" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="GT_atnRegularizeTSAttendance.aspx.vb" Inherits="GT_atnRegularizeTSAttendance" %>
...
<div id="div1" class="page">
    <div id="div2" class="caption">
					<asp:Label ID="LabelatnAppliedApplications" runat="server"  Text="List Time Short Attendance"></asp:Label>
    </div>
