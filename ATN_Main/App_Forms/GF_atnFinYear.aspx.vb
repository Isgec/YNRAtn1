Partial Class GF_atnFinYear
  ...
  End Sub
  Private _EditUrl As String = "~/ATN_Main/App_Edit/EF_atnFinYear.aspx"
  Private _AddUrl As String = "~/ATN_Main/App_Create/AF_atnFinYear.aspx"
  Private _InfoUrl As String = "~/ATN_Main/App_Display/DF_atnFinYear.aspx"
