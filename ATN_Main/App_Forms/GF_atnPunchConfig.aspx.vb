Partial Class GF_atnPunchConfig
  ...
  End Sub
  Private _EditUrl As String = "~/ATN_Main/App_Edit/EF_atnPunchConfig.aspx"
  Private _AddUrl As String = "~/ATN_Main/App_Create/AF_atnPunchConfig.aspx"
  Private _InfoUrl As String = "~/ATN_Main/App_Display/DF_atnPunchConfig.aspx"
