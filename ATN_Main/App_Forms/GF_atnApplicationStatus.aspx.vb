Partial Class GF_atnApplicationStatus
  ...
  End Sub
  Private _EditUrl As String = "~/ATN_Main/App_Edit/EF_atnApplicationStatus.aspx"
  Private _AddUrl As String = "~/ATN_Main/App_Create/AF_atnApplicationStatus.aspx"
  Private _InfoUrl As String = "~/ATN_Main/App_Display/DF_atnApplicationStatus.aspx"
