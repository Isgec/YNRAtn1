<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="GF_atnProcessed1Punch.aspx.vb" Inherits="GF_atnProcessed1Punch" title="Maintain List: Processed Punch" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cph1" runat="Server">
	<div id="div1" class="page">
    <div id="div2" class="caption">
				<asp:Label ID="LabelatnProcessedPunch" runat="server" Text="List Processed Punch" ></asp:Label>
    </div>
						...
						<asp:TemplateField>
							<ItemTemplate>
								<table>
									<tr>
										<td>
											<asp:ImageButton ID="Edit" runat="server" AlternateText="Edit" Enabled='<%# EVal("Enabled") %>' Visible='<%# Eval("Editable") %>' ToolTip="Edit the record." SkinID="Edit" CommandArgument='<%# Bind("AttenID") %>' OnClick="Edit_Click" />
										</td>
										<td>
										...
										<td>
											<asp:ImageButton ID="cmdConvert" runat="server" AlternateText="Convert" ToolTip="Convert Present to Absent." ImageUrl="~/App_Themes/Default/Images/BillBlock.png" CommandArgument='<%# Bind("AttenID") %>' OnClick="CmdConvert_Click" OnClientClick="return confirm('Convert attendance status ToolTip ABSENT ?');" />
										</td>
									</tr>
								</table>
							</ItemTemplate>
