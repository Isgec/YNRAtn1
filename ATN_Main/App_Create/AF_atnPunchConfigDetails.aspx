<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="AF_atnPunchConfigDetails.aspx.vb" Inherits="AF_atnPunchConfigDetails" title="Add: Punch Config Details" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cph1" Runat="Server">
<div id="div1" class="page">
<asp:UpdatePanel ID="UPNL1" runat="server" >
  <ContentTemplate>
    <asp:Label ID="LabelatnPunchConfigDetails" runat="server" Text="Add Punch Config Details" ></asp:Label>
    <LGM:ToolBar0 
      ID = "ToolBar0_1"
      ToolType = "lgNMAdd"
	...
	<InsertItemTemplate>
		<table>
			<tr>
				...
				<td>
					<asp:Label ID="TextSerialNo" runat="server" Text="0" />
				</td>
			</tr>
			<tr>
...
<asp:ObjectDataSource 
  ...
  runat = "server" >
<SelectParameters>
  <asp:QueryStringParameter DefaultValue="0" Name="SerialNo" QueryStringField="Code" Type="Int32" />
</SelectParameters>
<InsertParameters>
