<%@ Page Title="ISGEC:Print Attendance Sheet" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="GP_atnAttendanceNSheet.aspx.vb" Inherits="GP_atnAttendanceNSheet" %>
...
<div id="div1" runat="server" class="page">
		...
		<script type="text/javascript">
			...
			function print_atndReport() {
				...
				url = url + '?reportname=attendancensheet';
