<%@ Page Title="ISGEC:Print TS Report" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="GP_atnTSReport.aspx.vb" Inherits="GP_atnTSReport" %>
	...
	<div id="div1" runat="server" class="page">
		...
		<script type="text/javascript">
			...
			function print_detail() {
				...
				url = url + '&cate=' + $get('<%= F_Cate.ClientID %>').checked;
				url = url + '&typ=d';
				window.open(url, nam, 'left=20,top=20,width=1000,height=500,toolbar=1,resizable=1,scrollbars=1');
				return false;
			}
		</script>
