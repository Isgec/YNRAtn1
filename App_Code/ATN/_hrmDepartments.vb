...
Namespace SIS.ATN
  ...
  Partial Public Class hrmDepartments
    ...
    Public Shared Function SelectList(ByVal orderBy As String) As List(Of SIS.ATN.hrmDepartments)
      Dim Results As List(Of SIS.ATN.hrmDepartments) = Nothing
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          ...
          _RecordCount = -1
          Results = New List(Of SIS.ATN.hrmDepartments)()
          Con.Open()
          Dim Reader As SqlDataReader = Cmd.ExecuteReader()
          While (Reader.Read())
            Results.Add(New SIS.ATN.hrmDepartments(Reader))
          End While
          Reader.Close()
    ...
    Public Shared Function GetByID(ByVal DepartmentID As String) As SIS.ATN.hrmDepartments
      Dim Results As SIS.ATN.hrmDepartments = Nothing
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          ...
          Dim Reader As SqlDataReader = Cmd.ExecuteReader()
          If Reader.Read() Then
            Results = New SIS.ATN.hrmDepartments(Reader)
          End If
          Reader.Close()
        End Using
      End Using
    ...
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function SelectList(ByVal startRowIndex As Integer, ByVal maximumRows As Integer, ByVal orderBy As String, ByVal SearchState As Boolean, ByVal SearchText As String) As List(Of SIS.ATN.hrmDepartments)
      Dim Results As List(Of SIS.ATN.hrmDepartments) = Nothing
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
    ...
    Public Shared Function Delete(ByVal Record As SIS.ATN.hrmDepartments) As Int32
