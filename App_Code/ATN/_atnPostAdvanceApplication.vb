...
Namespace SIS.ATN
  <DataObject()> _
  Partial Public Class atnPostAdvanceApplication
    ...
    Private _ExecutionStateATN_ExecutionStates As SIS.ATN.atnExecutionStates
    ...
    Public ReadOnly Property ApplStatusIDATN_ApplicationStatus() As SIS.ATN.atnApplicationStatus
      ...
      End Get
    End Property
    Public ReadOnly Property ExecutionStateATN_ExecutionStates() As SIS.ATN.atnExecutionStates
      Get
        If _ExecutionStateATN_ExecutionStates Is Nothing Then
          _ExecutionStateATN_ExecutionStates = SIS.ATN.atnExecutionStates.GetByID(_ExecutionState)
        End If
        Return _ExecutionStateATN_ExecutionStates
      End Get
    End Property
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function GetByID(ByVal LeaveApplID As Int32) As SIS.ATN.atnPostAdvanceApplication
      Dim Results As SIS.ATN.atnPostAdvanceApplication = Nothing
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          Cmd.CommandText = "spatnPostAdvanceApplicationSelectByID"
          ...
          If Reader.Read() Then
            Results = New SIS.ATN.atnPostAdvanceApplication(Reader)
          End If
          Reader.Close()
        End Using
      End Using
    ...
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function GetByID(ByVal LeaveApplID As Int32, ByVal CardNo As String) As SIS.ATN.atnPostAdvanceApplication
      Return GetByID(LeaveApplID)
    End Function
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function GetByCardNo(ByVal CardNo As String, ByVal OrderBy as String) As List(Of SIS.ATN.atnPostAdvanceApplication)
      Dim Results As List(Of SIS.ATN.atnPostAdvanceApplication) = Nothing
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          If OrderBy = String.Empty Then OrderBy = "CardNo"
          Cmd.CommandType = CommandType.StoredProcedure
          Cmd.CommandText = "spatnPostAdvanceApplicationSelectByCardNo"
          ...
          SIS.SYS.SQLDatabase.DBCommon.AddDBParameter(Cmd, "@AdvanceApplication",SqlDbType.Bit,2, 1)
          Cmd.Parameters.Add("@RecordCount", SqlDbType.Int)
          Cmd.Parameters("@RecordCount").Direction = ParameterDirection.Output
          _RecordCount = -1
          Results = New List(Of SIS.ATN.atnPostAdvanceApplication)()
          Con.Open()
          Dim Reader As SqlDataReader = Cmd.ExecuteReader()
          While (Reader.Read())
            Results.Add(New SIS.ATN.atnPostAdvanceApplication(Reader))
          End While
          Reader.Close()
    ...
    End Function
    <DataObjectMethod(DataObjectMethodType.Select)> _
    Public Shared Function SelectList(ByVal startRowIndex As Integer, ByVal maximumRows As Integer, ByVal orderBy As String, ByVal SearchState As Boolean, ByVal SearchText As String, ByVal CardNo As String) As List(Of SIS.ATN.atnPostAdvanceApplication)
      Dim Results As List(Of SIS.ATN.atnPostAdvanceApplication) = Nothing
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          If OrderBy = String.Empty Then OrderBy = "CardNo"
          Cmd.CommandType = CommandType.StoredProcedure
					If SearchState Then
						Cmd.CommandText = "spatnPostAdvanceApplicationSelectListSearch"
						SIS.SYS.SQLDatabase.DBCommon.AddDBParameter(Cmd, "@KeyWord", SqlDbType.NVarChar, 250, SearchText)
					Else
						Cmd.CommandText = "spatnPostAdvanceApplicationSelectListFilteres"
    ...
    Public Shared Function Update(ByVal Record As SIS.ATN.atnPostAdvanceApplication) As Int32
      Dim _Result as Integer = 0
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          Cmd.CommandText = "spatnPostAdvanceApplicationUpdate"
    ...
    Public Sub New(ByVal Reader As SqlDataReader)
      ...
      _ExecutionStateATN_ExecutionStates = New SIS.ATN.atnExecutionStates("ATN_ExecutionStates3",Reader)
    End Sub
