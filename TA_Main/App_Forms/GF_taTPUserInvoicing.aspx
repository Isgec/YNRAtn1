<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="GF_taTPUserInvoicing.aspx.vb" Inherits="GF_taTPUserInvoicing" title="Maintain List: User Travel Invoices" %>
<asp:Content ID="CPHtaTPUserInvoicing" ContentPlaceHolderID="cph1" Runat="Server">
<div class="ui-widget-content page">
<div class="caption">
    <asp:Label ID="LabeltaTPUserInvoicing" runat="server" Text="&nbsp;List: User Travel Invoices"></asp:Label>
</div>
<div class="pagedata">
<asp:UpdatePanel ID="UPNLtaTPUserInvoicing" runat="server">
  <ContentTemplate>
    ...
    <LGM:ToolBar0 
      ...
      ToolType = "lgNMGrid"
      EditUrl = "~/TA_Main/App_Edit/EF_taTPUserInvoicing.aspx"
      EnableAdd = "False"
      ValidationGroup = "taTPUserInvoicing"
      runat = "server" />
    <asp:UpdateProgress ID="UPGStaTPUserInvoicing" runat="server" AssociatedUpdatePanelID="UPNLtaTPUserInvoicing" DisplayAfter="100">
      <ProgressTemplate>
    ...
    <table>
      ...
      <tr>
        <td></td>
        <td><asp:Button ID="cmdSubmit" runat="server" Text="Submit"  /></td>
      </tr>
    </table>
    </asp:Panel>
    ...
    <asp:GridView ID="GVtaTPUserInvoicing" SkinID="gv_silver" runat="server" ShowFooter="true" DataSourceID="ODStaTPUserInvoicing" DataKeyNames="InvoiceNo">
      <Columns>
...
--%>
    ...
    <asp:ObjectDataSource 
      ...
      SelectMethod = "UZ_taTPUserInvoicingSelectList"
      TypeName = "SIS.TA.taTPUserInvoicing"
      SelectCountMethod = "taTPUserInvoicingSelectCount"
  ...
  <Triggers>
    <asp:AsyncPostBackTrigger ControlID="GVtaTPUserInvoicing" EventName="PageIndexChanged" />
